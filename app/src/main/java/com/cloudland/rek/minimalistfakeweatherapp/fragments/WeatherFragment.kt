package com.cloudland.rek.minimalistfakeweatherapp.fragments
...
import com.cloudland.rek.minimalistfakeweatherapp.views.ViewFutureWeather
...
class WeatherFragment : Fragment() {
    ...
    companion object {
        ...
        fun newInstance(entity: com.cloudland.rek.minimalistfakeweatherapp.architecture.WeatherEntity): WeatherFragment {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val args = arguments
        if (args != null) {
            val weatherEntity = Gson().fromJson<com.cloudland.rek.minimalistfakeweatherapp.architecture.WeatherEntity>(
                args.getString(JSON_ENTITY), com.cloudland.rek.minimalistfakeweatherapp.architecture.WeatherEntityFake::class.java
            )
    ...
    private fun setBgColor(entity: com.cloudland.rek.minimalistfakeweatherapp.architecture.WeatherEntity) {
    ...
    private fun bindPrimaryData(entity: com.cloudland.rek.minimalistfakeweatherapp.architecture.WeatherEntity, tempUnit: String) {
...
//        imgCityWeather.setImageResource(imgs.getResourceId(entity.weatherIconIndex, -1))
    ...
    private fun bindFutureData(view: ViewFutureWeather, entity: com.cloudland.rek.minimalistfakeweatherapp.architecture.WeatherFutureDay, tempUnit: String) {
